...
model = train(dataloader, device, learning_rate=0.001, num_epochs=10, batch_size=batch_size, hidden_size_query=hidden_size_query, hidden_size_answer=hidden_size_answer, wandb_yes=True)
